...
class SoftActorCritic:
    ...
    def update_model_based(self, data):
        ...
        with torch.no_grad():
            ...
            a_pi3, logp_a3 = self.ac.pi(o_hat3)
            
            q1_pi_targ = self.ac_targ.q1(o_hat3, a_pi3)
            q2_pi_targ = self.ac_targ.q2(o_hat3, a_pi3)
            q_pi_targ = r_hat2 + self.gamma * (torch.min(q1_pi_targ, q2_pi_targ) - self.alpha * logp_a3)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_name', type=str, default='sac_m2')
