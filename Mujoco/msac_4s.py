...
class SoftActorCritic:
    ...
    def update_model_based(self, data):
        ...
        with torch.no_grad():
            ...
            a_pi4, _ = self.ac.pi(o_hat4)
            o_hat5, r_hat4 = self.dynam(o_hat4, a_pi4)
            a_pi5, logp_a5 = self.ac.pi(o_hat5)
            
            q1_pi_targ = self.ac_targ.q1(o_hat5, a_pi5)
            q2_pi_targ = self.ac_targ.q2(o_hat5, a_pi5)
            q_pi_targ = r_hat2 + self.gamma * ( r_hat3 + self.gamma * ( r_hat4 + self.gamma * (torch.min(q1_pi_targ, q2_pi_targ) - self.alpha * logp_a5)) )
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_name', type=str, default='sac_m4')
